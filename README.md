# genpark-parallel-pr-cloud-sandbox-agent-runner-skill
...
> **GenPark AI Agent Skill** -- Parallel PR cloud sandbox provisioner for concurrent AI coding agent PR work (Hoplite style)
